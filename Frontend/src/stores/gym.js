...
export const useGymStore = defineStore('gym', {
  ...
  actions: {
    ...
    async createGym(gymData) {
      this.loading = true
      try {
        const response = await axios.post('http://localhost:5000/api/superadmin/gyms', gymData)
    ...
    async updateGym(id, gymData) {
      this.loading = true
      try {
        const response = await axios.patch(`http://localhost:5000/api/superadmin/gyms/${id}`, gymData)
    ...
    async deleteGym(id) {
      this.loading = true
      try {
        await axios.delete(`http://localhost:5000/api/superadmin/gyms/${id}`)
    ...
    async fetchGymAdmins() {
      this.loading = true
      try {
        const response = await axios.get('http://localhost:5000/api/superadmin/gym-admins')
    ...
    async createGymAdmin(adminData) {
      this.loading = true
      try {
        const response = await axios.post('http://localhost:5000/api/superadmin/gym-admins', adminData)
    ...
    async updateGymAdmin(id, adminData) {
      this.loading = true
      try {
        const response = await axios.patch(`http://localhost:5000/api/superadmin/gym-admins/${id}`, adminData)
    ...
    async deleteGymAdmin(id) {
      this.loading = true
      try {
        await axios.delete(`http://localhost:5000/api/superadmin/gym-admins/${id}`)
    ...
    async logoutGymAdmin(id) {
      this.loading = true
      try {
        await axios.post(`http://localhost:5000/api/superadmin/gym-admins/${id}/logout`)
        return { success: true }
      } catch (error) {
    ...
    async logoutGymUsers(id) {
      this.loading = true
      try {
        await axios.post(`http://localhost:5000/api/superadmin/gym-admins/${id}/logout-users`)
        return { success: true }
      } catch (error) {
    ...
    async updateTrainer(id, trainerData) {
      this.loading = true
      try {
        const response = await axios.put(`http://localhost:5000/api/Trainer/${id}`, trainerData)
